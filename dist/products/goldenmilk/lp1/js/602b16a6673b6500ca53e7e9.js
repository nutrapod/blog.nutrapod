...
;(function ($) {
  ...
  $(document).on("submit", "form.shogun-form-box", function(evt) {
    evt.preventDefault();
  });
  ...
  function getRadioInputs(formRootEl) {
    var radioInputList = [];
    var radioGroups = $(formRootEl).find(".shogun-form-radio-button");
  ...
  function getCheckboxInputs(formRootEl) {
    var checkBoxList = [];
    var checkBoxGroups = $(formRootEl).find(".shogun-form-check-box");
  ...
  function getAllFieldValues(formFields, type) {
    var fields = [];
    formFields.each(function() {
      fields.push(getFieldValues($(this), type));
    });
    return fields;
  }
  ...
  function submitForm(formData) {
    ...
    fields = fields.concat(
      getAllFieldValues($formRoot.find("select"), "select")
    );
    fields = fields.concat(
      getAllFieldValues($formRoot.find("input[type='email']"), "email")
    );
    fields = fields.concat(
      getAllFieldValues($formRoot.find("input[type='text']"), "text")
    );
    fields = fields.concat(
      getAllFieldValues($formRoot.find("textarea"), "textarea")
    );
    fields = fields.concat(getRadioInputs($formRoot));
    fields = fields.concat(getCheckboxInputs($formRoot));
